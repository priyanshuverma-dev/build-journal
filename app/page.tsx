      ...
      <div className="bg-grid">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feat, idx) => (
                <Card key={idx} className="min-h-36">
                  <CardBody>
        ...
        <section id="pricing" className="py-20">
          <div className="container mx-auto px-6 text-center max-w-2xl">
            ...
            <p className="text-xl mt-6">
              Build Journal is <strong>free</strong> for now! You can use all
              its features at no cost.
            </p>
            <p className="text-lg">
              As we grow and add more features, we’ll introduce premium plans
              with additional benefits, but for now, enjoy full access to
              everything for free.
            </p>
          </div>
        </section>
        ...
        <section id="about" className="container mx-auto px-4 py-16">
          ...
          <p className="text-lg mt-6 text-center max-w-2xl mx-auto">
            Build Journal is a powerful tool designed to help developers
            document every step of their project journey, from the initial idea
            to completion. Whether you’re working on a small side project or a
        ...
        <section className="py-16">
          <div className="container mx-auto text-center">
            ...
            <p className="text-lg mt-4 text-center max-w-2xl mx-auto">
              The platform is designed to make project management easier and
